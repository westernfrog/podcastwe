      ...
      <div className="container my-5 py-5">
        ...
        <div className="row flex-row-reverse align-items-stretch mt-5 pt-5">
          <div className="col-md-7 order-last">
            ...
            <ul className="lh-lg">
              <li className="fs-4 fw-bold">Information Collection and Use</li>
              <p className="fs-6">
              ...
              <li className="fs-4 fw-bold">Cookies and Analytics</li>
              <p className="fs-6">
              ...
              <li className="fs-4 fw-bold">Information Sharing</li>
              <p className="fs-6">
              ...
              <li className="fs-4 fw-bold">Your Rights</li>
              <p className="fs-6">
              ...
              <li className="fs-4 fw-bold">Changes to this Policy</li>
              <p className="fs-6">
          ...
          <div className="col-md-4 order-first mb-5 position-sticky">
            <div className="">
              <p className="fs-2 mb-4">Table of Contents</p>
              <ul className="text-dm fs-5 lh-lg">
