                      ...
                      <Modal.Body>
                        <Text id="modal-description">
                          <p className="fs-6 mb-4">
                            ...
                            and share personal information that we obtain from
                          ...
                          <ul className="lh-lg text-dm ms-0 ps-0 text-black">
                            ...
                            <p className="fs-6">
                              ...
                              as your name and email address, when you register
                              to use our website or subscribe to our services.
                              We may also collect information about your use of
                              our website, such as your IP address, browser
                              type, and the episodes you listen to. We use your
                              personal information to communicate with you,
                              respond to your inquiries, and provide you with
                              our podcast or other promotional materials.
                            </p>
                            ...
                            <p className="fs-6">
                              ...
                              third parties for their own marketing purposes. We
                            ...
                            <p className="fs-6">
                              ...
                              materials at any time by following the
                            ...
                            <p className="fs-6">
                              ...
                              requirements. We will provide notice of any
                              material changes to this policy by posting the new
                              policy on our website. If you have any questions
                              or concerns about this Privacy Policy, please
                              contact us at [podcastwe@gmail.com].
                            </p>
                          </ul>
                        </Text>
                      </Modal.Body>
                  ...
                  <li className="nav-item mb-2">
                    ...
                    >
                      ...
                      <Modal.Body>
                        <Text id="modal-description">
                          <p className="fs-6 mb-4">
                            This page explains our terms of service, which
                            contain important information about your legal
                            rights. When you use podcastwe.com, you&apos;re
                          ...
                          <ul className="lh-lg text-dm ms-0 ps-0 text-black">
                            ...
                            <p className="fs-6">
                              ...
                              property of our company and may not be reproduced
                              or used without our permission.
                            </p>
                            <li className="fs-5 fw-bold" id="2">
                            ...
                            <p className="fs-6">
                              ...
                              user-generated content on our website, you grant
                              us a non-exclusive, royalty-free, perpetual, and
                            ...
                            <p className="fs-6">
                              You may not use our website for any unlawful
                              purpose or in any way that may harm our company or
                              other users of our website. You may not post or
                              transmit any content that is offensive,
                            ...
                            <p className="fs-6">
                              We are not liable for any damages or harm
                              resulting from your use of our website or any
                              content posted on our website. We do not warrant
                              the accuracy or completeness of any information on
                              our website and we are not responsible for any
                              errors or omissions.
                            </p>
                            <li className="fs-5 fw-bold" id="5">
                              Indemnification
                            ...
                            <p className="fs-6">
                              ...
                              harmless from any claims, damages, or costs
                              arising from your use of our website or your
                            ...
                            <p className="fs-6">
                              ...
                              laws of [insert governing law], and any disputes
                              arising from these terms and conditions will be
