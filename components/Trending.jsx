...
export default function Trending(props) {
  return (
    <>
      <div className="pt-3" id="trending">
          ...
          <div className="row d-flex align-items-center justify-content-between">
            ...
            <div className="col-md-6">
              <p className="mb-0 fs-6 text-muted">
                Stay up-to-date with the latest and most significant headlines
                of the week on our &apos;Trends of This Week&apos; page,
                offering comprehensive coverage and insightful analysis of the
